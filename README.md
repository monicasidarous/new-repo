significant changes need to be made (ideally) in order to commit. when submitting a commit, make the description as thorough as possible as you don't know when you'll next be looking at the changes.
